...
- Compara cambios entre diferentes puntos en el tiempo
- Exporta historial de diffs a JSON
...
│   ├── utils/
│   │   ├── gitDiffTracker.js     # Lógica principal de seguimiento de diffs
...
# Opcional: Configurar observador de diffs (valores por defecto mostrados)
...
Una vez que el servidor esté en ejecución, tus diffs de git se preservan automáticamente mediante:
...
Obtener el diff de git actual (cambios preparados y no preparados)
...
También puedes usar el Git Diff Tracker de forma programática en tu código Node.js:
...
- Se usan JWTs para la gestión de sesiones

### Historial de Git Diff
- Los diffs se almacenan en `.git/diff-history/`
- Se mantienen un máximo de 50 diffs (limpieza automática)
...
- El tracker mantiene automáticamente solo los últimos 50
...
- **[GIT_DIFF_TRACKER.md](./GIT_DIFF_TRACKER.md)** - Referencia de API del Git Diff Tracker y detalles
